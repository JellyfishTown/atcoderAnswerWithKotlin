...
//fun past.point200.past.point400.participated.abc106.participated.abc104.participated.past.point100.past.point300.main(args: Array<String>) {
//    val (n, m, s, t) = readLine()!!.split(' ').map(String::toInt)
//    val uList = mutableListOf<Int>()
//    val vList = mutableListOf<Int>()
//    val aList = mutableListOf<Int>()
//    val bList = mutableListOf<Int>()
//
//    val participated.getYenMatrix = DijkstraMatrix(n)
//    val participated.getSnuukMatrix = DijkstraMatrix(n)
//    for (i in 1..m) {
//        val (u, v, a, b) = readLine()!!.split(' ').map(String::toInt)
//        uList.add(u)
//        vList.add(v)
...
//        bList.add(b)
//
//        participated.getYenMatrix.set(u, v, a)
//        participated.getSnuukMatrix.set(u, v, b)
//    }
//
//
//    for (i in 0 until n) {
...
//            val yenCost1 = participated.getYenMatrix.getCost(s, j)
//            val yenCost2 = participated.getYenMatrix.getCost(j, t)
//            val snuukCost1 = participated.getSnuukMatrix.getCost(s, j)
//            val snuukCost2 = participated.getSnuukMatrix.getCost(j, t)
